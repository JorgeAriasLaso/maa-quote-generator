...
// Build the SAME filename you used before
        ...
        <div className="w-20 h-1 bg-yellow-400 mx-auto"></div>
            ...
            <div className="mb-12 mt-16" style={{ breakInside: 'avoid', pageBreakInside: 'avoid' }}>
              ...
              <Card className="bg-slate-50 p-6">
                <div className="space-y-4">
                  {/* Students breakdown - Hide for Additional Services */}
                  {quote.tripType !== "Additional Services" && (
                  ...
                  {/* Teachers breakdown - Hide for Additional Services */}
                  {quote.tripType !== "Additional Services" && (
...
</div>  {/* closes the marginTop wrapper */}
</div>  {/* closes inner max-w */}
</div>  {/* closes flex-1 */}
