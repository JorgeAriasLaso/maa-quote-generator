...
export const insertQuoteSchema = createInsertSchema(quotes).omit({
  ...
  costLunchPerDay: z.string().nullable().optional(),
  costDinnerPerDay: z.string().nullable().optional(),
  costLocalTransportationCard: z.string().nullable().optional(),
  costStudentCoordination: z.string().nullable().optional(),
  costTeacherCoordination: z.string().nullable().optional(),
